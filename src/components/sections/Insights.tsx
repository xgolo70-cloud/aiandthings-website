    ...
    <section id="insights" className="bg-white py-40 border-b border-neutral-100 relative cursor-default">
      <div className="container mx-auto px-6 relative z-10">
          <div className="flex items-end justify-between mb-24">
              <h2 className="text-7xl md:text-9xl arabic-heading font-extrabold text-brand-dark tracking-tighter">
                  The Journal.
              </h2>
              <span className="text-sm arabic-text uppercase tracking-widest text-neutral-400 hidden md:block">Read More</span>
          </div>
              ...
              {insights.map((item, index) => (
                  ...
                  >
                      <div className="w-full md:w-1/4 mb-4 md:mb-0">
                          <span className="text-sm arabic-text text-neutral-500 group-hover:text-brand-accent transition-colors">0{index + 1} / {item.category}</span>
                      </div>
                      <div className="w-full md:w-1/2">
                          <h3 className="text-4xl md:text-6xl arabic-heading font-bold text-neutral-900 group-hover:-translate-x-4 transition-transform duration-500 ease-out">
                              {item.title}
                          </h3>
                      </div>
                      <div className="w-full md:w-1/4 flex justify-end items-center mt-4 md:mt-0">
                          <span className="text-sm arabic-text text-neutral-400 mr-8">{item.date}</span>

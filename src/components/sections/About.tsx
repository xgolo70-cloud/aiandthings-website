  ...
  return (
    <Section id="about" className="bg-white py-32">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          {/* Left: Huge Title */}
          <div>
              <h2 className="text-[5.5vw] leading-[0.9] font-bold tracking-tighter text-zinc-900 mb-10">
                  الجوهر<br/>
          ...
          <div className="flex flex-col justify-center space-y-12">
              <div className="pl-6 border-l border-brand-accent">
                  <p className="text-xl font-light leading-snug text-neutral-800 arabic-text">
